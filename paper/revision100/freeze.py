...
def main():
    ...
    content={'release':'100-capital-2026-09-09','note':'Explicit release operation. Build validates these hashes and never rewrites them.','environment':environment(),'files':{str(p.relative_to(ROOT)):sha(p) for p in paths}}
