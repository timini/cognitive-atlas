...
def test_matching_group_and_resume_protection(tmp_path, monkeypatch):
    ...
    write_csv('places.csv', [{'id': 'GB', 'country_name': 'United Kingdom', 'capital_name': 'London', 'latitude': 51.5, 'longitude': -.12},
                             {'id': 'FR', 'country_name': 'France', 'capital_name': 'Paris', 'latitude': 48.85, 'longitude': 2.35},
                             {'id': 'DE', 'country_name': 'Germany', 'capital_name': 'Berlin', 'latitude': 52.52, 'longitude': 13.40}])
