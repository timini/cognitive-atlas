...
def build(places_path, countries_path):
    ...
    for iso, name in ADDITIONS.items():
        ...
        if country is None:
            country = {
                'BH': {'ADMIN': 'Bahrain', 'CONTINENT': 'Asia', 'SUBREGION': 'Western Asia'},
                'TO': {'ADMIN': 'Tonga', 'CONTINENT': 'Oceania', 'SUBREGION': 'Polynesia'},
                'WS': {'ADMIN': 'Samoa', 'CONTINENT': 'Oceania', 'SUBREGION': 'Polynesia'},
    ...
    metadata = {'dataset_version': 'capitals-100-v3', 'capital_count': 100,
                    ...
                    'sources': [{'url': 'https://raw.githubusercontent.com/nvkelso/natural-earth-vector/master/geojson/' + name,
